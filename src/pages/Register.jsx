    ...
    <section className='flex '>
        ...
        <form  onSubmit={handleSubmit} className='w-full max-w-md mx-auto bg-white p-8 rounded-lg border border-gray-200 shadow'>
            <div className="flex flex-col  justify-center ">
                ...
                <input type="text" value={name} onChange={(e)=>{setName(e.target.value)}} placeholder='Enter Your Name' className='border focus-within:border-blue-600 border-gray-100 outline-none rounded py-2 px-2 mb-4  ' />
                ...
                <button type='submit' className='bg-black text-white w-full py-2 font-semibold rounded-lg hover:bg-gray-900 transition-colors duration-150 cursor-pointer mb-6'>Sign Up</button>

                <h2 className='text-center'>I have an account already? <Link to={'/login'} className='text-sky-500'>LogIn</Link></h2>
            </div>
        </form> 
        </div>
        ...
        <div className="h-full flex flex-col justify-center items-center">
            <img  className='h-[710px] w-full object-cover' src="https://res.cloudinary.com/deif4iuok/image/upload/v1752416971/register_vee0vf.webp" alt="" />
        </div>
        </div>
    </section>
  )
